...
dictFromLine str = dictFromList
                    <| filter keyFilter
                    <| split ""
                    <| String.dropRight 7 str

-- Create a dict from a list of characters
dictFromList : List String -> Dict String Int
dictFromList list = foldl listFold (Dict.fromList []) list

-- Handle updates to a dict
...
-- Function for fold to count characters
listFold : String -> Dict String Int -> Dict String Int
listFold char dict =
    let new = case (Dict.get char dict) of
        Nothing -> Dict.insert char 1 dict
        Just val -> Dict.update char process dict
    in
        new
